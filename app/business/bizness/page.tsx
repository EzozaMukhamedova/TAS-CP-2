...
export default function BiznessPage() {
    ...
    <div className="container mx-auto px-4 py-8 ">
      ...
      <section className="py-10 md:py-14 bg-[#F7FAFF]">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {/* Maqsadli Qidiruv */}
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-indigo-50 text-[#1C3990] ring-1 ring-[#1C3990]/10">
                <Search className="h-5 w-5" />
              </div>
              <h3 className="font-semibold text-slate-900">Maqsadli Qidiruv</h3>
              <p className="mt-1 text-sm text-slate-600">
                M&A doirasidagi mos keluvchi kompaniyani aniqlash va tahlil
                qilish
              </p>
            </div>

            {/* Moliiyaviy-huquqiy tahlil */}
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-indigo-50 text-[#1C3990] ring-1 ring-[#1C3990]/10">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Maqsad kompaniyaning moliyaviy va huquqiy holati bo‘yicha
                tekshiruv
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Bitim Tuzish</h3>
              <p className="mt-1 text-sm text-slate-600">
                Qimmatli qog‘ozlar, narx va shartnomani yakunlash
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-10 md:py-14">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-[#1C3990] text-white">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Maqsadga muvofiq keluvchi M&A strategiyasini ishlab chiqish
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Qimmat Baholash</h3>
              <p className="mt-1 text-sm text-slate-600">
                Professional metodlar asosida kompaniya qiymatini aniqlash
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Risk Boshqaruvi</h3>
              <p className="mt-1 text-sm text-slate-600">
                M&A jarayonidagi huquqiy, moliyaviy va operatsion risklarni
                kamaytirish
              </p>
            </div>
          </div>
      ...
      <section className="py-10 md:py-14">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {/* Ko‘chmas mulk va aktiv boshqaruvi */}
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 ring-1 ring-black/5">
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-indigo-50 text-[#1C3990] ring-1 ring-[#1C3990]/10">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Mulk va aktivlarni konsolidatsiya qilish, qiymatni oshirish
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Xalqaro Bitimlar</h3>
              <p className="mt-1 text-sm text-slate-600">
                Xorijiy M&A bitimlarini rejalash va amalga oshirish
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                KOB uchun tezkor va xavfsiz M&A yechimlari
              </p>
            </div>
          </div>
        </div>
