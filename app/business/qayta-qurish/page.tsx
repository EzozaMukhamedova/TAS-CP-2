...
import { PenTool, Zap, Leaf, CheckCircle2 } from "lucide-react";

export default function QaytaQurishPage() {
    ...
    <div className="container mx-auto px-4 py-8 ">
      ...
      <div className="grid lg:grid-cols-2 items-center gap-8 mb-12 pt-[40px]">
        ...
        <div className="flex justify-center lg:justify-start">
          <div
            className="relative rounded-2xl overflow-hidden bg-white shadow-lg ring-1 ring-black/5 hover:shadow-2xl transition-shadow cursor-pointer
                 w-[280px] h-[280px] md:w-[420px] md:h-[420px] lg:w-[543px] lg:h-[543px]"
          >
            {/* Variant A: <img> (SVG uchun oddiy va barqaror) */}
            <img
              src="/svg/qaytaQurishTiklanish.svg"
              alt="Company History"
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Eng so‘nggi arxitektura tendensiyalari va dizayn yechimlarini
                qo‘llaymiz
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Energiya tejovchi materiallar va texnologiyalardan foydalanish
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Atrof-muhitga zarar yetkazmaydigan qurilish usullari
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-5">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <span className="text-sm text-slate-700">
                Mulk qiymatining sezilarli o‘sishi
              </span>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
              <CheckCircle2 className="h-5 w-5 text-[#1C3990]" />
              <span className="text-sm text-slate-700">
                Energiya xarajatlarining kamayishi
              </span>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
              <CheckCircle2 className="h-5 w-5 text-[#1C3990]" />
              <span className="text-sm text-slate-700">
                Zamonaviy qulayliklar va texnologiyalar
              </span>
            </div>
