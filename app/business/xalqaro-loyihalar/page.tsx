...
export default function XalqaroLoyihalarPage() {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {[
              {
                Icon: Globe2,
                title: "Xalqaro Rivojlantirish",
                desc: "Turli mamlakatlarda ko‘chmas mulk loyihalarini rivojlantirish va amalga oshirish",
              },
              {
                Icon: Handshake,
                title: "Mahalliy Hamkorlik",
                desc: "Mahalliy hamkorlar va hukumat organlari bilan strategik aloqalar o‘rnatish",
              },
              {
                Icon: BarChart3,
                title: "Bozor Tahlili",
                desc: "Xalqaro bozorlari chuqur tahlil qilish va investitsiya imkoniyatlarini aniqlash",
              },
              {
                Icon: ShieldCheck,
                title: "Risk Boshqaruvi",
                desc: "Xalqaro loyihalardagi risklarni baholash va boshqarish strategiyalari",
              },
              {
                Icon: CircleDollarSign,
                title: "Kross-Border Moliya",
                desc: "Xalqaro moliyaviy institutlar bilan hamkorlik va moliyalashtirish",
              },
              {
                Icon: BadgeCheck,
                title: "Sifat Nazorati",
                desc: "Xalqaro standartlarga mos sifat nazorati va loyiha boshqaruvi",
              },
            ].map(({ Icon, title, desc }) => (
              <div
                key={title}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {[
              {
                Icon: Globe2,
                title: "Global Tajriba",
                desc: "20+ yillik xalqaro loyihalar tajribasi va 50+ mamlakatlarda faoliyat",
              },
              {
                Icon: MapPin,
                title: "Mahalliy Bilim",
                desc: "Har bir bozorning o‘ziga xos xususiyatlari va qonunchiligini chuqur bilish",
              },
              {
                Icon: Handshake,
                title: "Strategik Hamkorlik",
                desc: "Dunyoning yetakchi moliya institutlari va rivojlanuvchi kompaniyalar bilan hamkorlik",
              },
            ].map(({ Icon, title, desc }) => (
              <div
                key={title}
