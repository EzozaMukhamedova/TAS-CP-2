...
export default function LogistikaInshootlariPage() {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Ombor Qurilishi</h3>
              <p className="mt-1 text-sm text-slate-600">
                Zamonaviy texnologiyalar bilan jihozlangan, tezkor
                saqlash/omborxona qurilishi
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Yuk tashish va taqsimlash uchun kompleks logistik markazlar
                boshqaruvi
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Transport tarmoqlari va bozorlar yaqinida optimal joylashuv
                tanlovi
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">24/7 Ishlash</h3>
              <p className="mt-1 text-sm text-slate-600">
                Kun-u tun ishlashga mos infratuzilma va avtomatlashtirish
                tizimlari
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Kuzatuv, kirish-nazorat va yong‘inga qarshi integratsiyalangan
                tizimlar
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Samaradorlik</h3>
              <p className="mt-1 text-sm text-slate-600">
                Tezkor yuk qabul/jo‘natish jarayonlari va operatsion
                optimizatsiya
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Yetkazib berish zanjiri uchun qulay joylashuv va samarali
                logistika
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Avtomatlashtirish va raqamlashtirish bilan aniq monitoring va
                tahlil
              </p>
            </div>
            ...
            {/* Moslashuvchanlik */}
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 ring-1 ring-black/5">
              <h3 className="font-semibold text-slate-900">Moslashuvchanlik</h3>
              <p className="mt-1 text-sm text-slate-600">
                Turli yuk turlari va hajmlarini qabul qilish uchun mos dizayn
              </p>
            </div>
          </div>
        </div>
