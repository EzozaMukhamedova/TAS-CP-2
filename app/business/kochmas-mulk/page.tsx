...
import { PenTool, Wrench, Brush, CheckCircle2 } from "lucide-react";

export default function KochmasMulkPage() {
      ...
      <section className="bg-[#F7FAFF]">
        <div className="container mx-auto px-4 py-10 md:py-14 text-center">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
            Ko'chmas mulk va rivojlantirish
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Ichki makonni zamonaviy dizayn va funksionallik bilan yangilash
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Texnik Yangilash</h3>
              <p className="mt-1 text-sm text-slate-600">
                Elektr, suv va vent tizimlari zamonaviy standartlarga
                moslashtirish
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Dizayn Yangilash</h3>
              <p className="mt-1 text-sm text-slate-600">
                Zamonaviy estetika va brendga mos vizual yechimlar
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-4 gap-6">
            {[
              {
                n: 1,
                t: "Tahlil va Baholash",
                d: "Mavjud binoning hozirgi holati va ehtiyojlarni aniqlash",
              },
              {
                n: 2,
                t: "Loyiha Ishlab Chiqish",
                d: "Renovatsiya loyihasi va byudjet bo‘yicha kelishuv",
              },
              {
                n: 3,
                t: "Amalga Oshirish",
                d: "Professional jamoalar tomonidan ishlarni o‘tkazish",
              },
              {
                n: 4,
                t: "Topshirish va Kafolat",
                d: "Loyiha topshiruvi va keyingi texnik yordam",
              },
            ].map((s) => (
              <div
                key={s.n}
              ...
              >
                <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-[#1C3990] text-white font-bold">
                  {s.n}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-5">
            {[
              ...
              >
                <CheckCircle2 className="h-5 w-5 text-[#1C3990]" />
