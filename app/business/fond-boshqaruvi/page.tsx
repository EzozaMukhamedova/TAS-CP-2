...
export default function FondBoshqaruviPage() {
      ...
      <section className="bg-[#F7FAFF]">
        <div className="container mx-auto px-4 py-10 md:py-14 text-center">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
            Fondlarni boshqarish loyihalari
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Fond Boshqaruvi</h3>
              <p className="mt-1 text-sm text-slate-600">
                Investitsiya fondlari uchun professional boshqaruv va nazorat
                qilish
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Kompaniyalarni sotib olish va qo‘shishning engil jarayonlarini
                ta’minlaymiz
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Investitsion imkoniyatlarni chuqur tahlil qilish va baholash
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Aniq maqsadlar va strategiyalar asosida investitsiya qilish
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Uzoq muddatli o‘sish va qiymat yaratishga yo‘naltirilgan
                yondashuv
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 text-center ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Barcha manfaatdor tomonlar bilan uzoq muddatli hamkorlik
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Yuqori Daromad</h3>
              <p className="mt-1 text-sm text-slate-600">
                Professional boshqaruv orqali yuqori investitsiya daromadi
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 ring-1 ring-black/5">
              ...
              <h3 className="font-semibold text-slate-900">Diversifikatsiya</h3>
              <p className="mt-1 text-sm text-slate-600">
                Turli sektor va loyihalar bo‘yicha investitsiyalarni taqsimlash
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white shadow-md hover:shadow-lg transition p-6 ring-1 ring-black/5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Tajribali mutaxassislar tomonidan puxta va tizimli boshqaruv
              </p>
            </div>
          </div>
        </div>
