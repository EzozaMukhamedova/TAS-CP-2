...
export default function QaytaEnergiyaPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 ">
      ...
      <div className="grid lg:grid-cols-2 gap-8 mb-12 pt-[83px]">
        <div className="lg:col-span-1 flex justify-center lg:justify-start">
          <div
            className="relative w-[543px] h-[543px] rounded-2xl overflow-hidden
                    bg-white shadow-lg ring-1 ring-black/5 hover:shadow-2xl
                    transition-shadow cursor-pointer"
          >
            <Image
              src="/svg/qaytaqurish.svg"
              alt="Company History"
              fill
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {[
              {
                Icon: Sun,
                title: "Quyosh Energiyasi Loyihalari",
                desc: "Quyosh panellari va fotovoltaik tizimlarni o‘rnatish va boshqarish",
              },
              {
                Icon: Wind,
                title: "Shamol Energiyasi Loyihalari",
                desc: "Shamol turbinalari va shamol elektr stansiyalarini qurish",
              },
              {
                Icon: BatteryCharging,
                title: "Energiya Saqlash Tizimlari",
                desc: "Zamonaviy bateriya va energiya saqlash yechimlarini joriy etish",
              },
              {
                Icon: Leaf,
                title: "Ekologik Maslahat",
                desc: "Atrof-muhitga ta’sirni baholash va ekologik sertifikatlash",
              },
              {
                Icon: Gauge,
                title: "Energiya Samaradorligi",
                desc: "Energiya iste’molini optimallashtirish va samaradorlik oshirish",
              },
              {
                Icon: Wrench,
                title: "Texnik Xizmat va Ta’mirlash",
                desc: "Obyektlar (ES/SShES) energiya tizimlari uchun texnik xizmat ko‘rsatish",
              },
            ].map(({ Icon, title, desc }) => (
              <div
                key={title}
      ...
      <section className="py-10 md:py-14">
        <div className="container mx-auto px-4">
          ...
          {/* ikon + title + izoh – markazda, 4 ta element */}
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="font-semibold text-slate-900">Ekologik Toza</h4>
              <p className="mt-1 text-sm text-slate-600 max-w-xs">
                CO2 chiqindilarini kamaytirish va atrof-muhtni himoya qilish
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-1 text-sm text-slate-600 max-w-xs">
                Energiya xarajatlarini 40% gacha kamaytirish imkoniyati
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-1 text-sm text-slate-600 max-w-xs">
                Tashqi energiya manbalariga bog‘liqlikni kamaytirish
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="font-semibold text-slate-900">Yuqori Sifat</h4>
              <p className="mt-1 text-sm text-slate-600 max-w-xs">
                Xalqaro standartlarga mos sifatli jihozlar va xizmatlar
              </p>
            </div>
          </div>
        </div>
